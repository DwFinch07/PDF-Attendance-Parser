...
#
# This project uses CustomTkinter
# 
# test_images and some UI elements from Tom Schimansky
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.home_frame_button_3 = customtkinter.CTkButton(self.home_frame, text="Button3", image=self.image_icon_image, compound="top")
        self.home_frame_button_3.grid(row=3, column=0, padx=20, pady=10)
        self.home_frame_button_4 = customtkinter.CTkButton(self.home_frame, text="Button4", image=self.image_icon_image, compound="bottom", anchor="w")
        ...
        self.open_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Home",
                                                   fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"),
                                                   image=self.home_image, anchor="w", command=self.select_file)
